            ...
            >
              ...
              <div className="p-8 flex flex-col flex-grow">
                <div className="flex items-center gap-2 text-gray-400 mb-4">
                  ...
                  <time dateTime={news.tanggal} className="text-[12px] font-bold uppercase tracking-wide">
                    {new Date(news.tanggal).toLocaleDateString('id-ID', { day: 'numeric', month: 'short', year: 'numeric' })}
                  </time>
                </div>
                
                <h2 className="text-[20px] font-[800] text-gray-900 leading-tight mb-4 group-hover:text-[#587F93] transition-colors line-clamp-2">
                  {news.judul}
                </h2>
                ...
                {news.hashtag && news.hashtag.length > 0 && (
                  <footer className="flex flex-wrap gap-2 mb-6">
                ...
                >
                  Baca Selengkapnya
                  <ArrowRight size={18} className="transition-transform duration-300 group-hover/btn:translate-x-2" aria-hidden="true" />
                </button>
              </div>
            </motion.article>
          ))}
