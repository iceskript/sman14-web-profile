            ...
            <section className="space-y-8">
              ...
              <div id="sosmed">
                ...
                <div className="flex gap-4">
                  ...
                  {/* Facebook */}
                  <a href="#https://www.facebook.com/smapas.samarinda?locale=id_ID" className="w-10 h-10 flex items-center justify-center bg-gray-50 rounded-full transition-all duration-300 shadow-sm group hover:bg-[#1877F2]">
                    <img 
                      src="/fb-logo.svg" 
                      alt="Facebook" 
                      className="w-5 h-5 transition-all duration-300 opacity-70 group-hover:opacity-100 group-hover:brightness-0 group-hover:invert" 
